...
export const ClientTable = () => {
    ...
    const deletedClient = async(id)=>{
        try{
            ...
            if(confirmDelete){
                const { data } = await axios.delete(`http://localhost:3000/cliente/delete/${id}`,{headers: headers} )
                getClients()
                alert(`${data.message}`)
            }
        }catch(err){
  ...
  return (
    <>
            <br /><br /><center>  <h1>Clientes</h1> </center><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
